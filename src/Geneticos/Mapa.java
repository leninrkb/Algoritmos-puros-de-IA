...
public class Mapa {
    ...
    static Camino seleccionarMetodo(Camino c) {
        switch (c.id) {
            case "c0":
                return caminoC0();
            case "c1":
    ...
    static Camino caminoC0() {
        List<Camino> ca = new ArrayList<>();
        ca.add(c1);
        ca.add(c2);
        ca.add(c3);

        Camino s = ca.get(Algoritmo.random(0, ca.size() - 1));
        return s;
    }

    static Camino caminoC1() {
        return c4;
    }

    static Camino caminoC2() {
        List<Camino> ca = new ArrayList<>();
        ca.add(c7);
        ca.add(c8);
        ca.add(c10);
    ...
    static Camino caminoC3() {
        return c5;
    }

    static Camino caminoC4() {
        List<Camino> ca = new ArrayList<>();
        ca.add(c7);
        ca.add(c6);
